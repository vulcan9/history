...
define(
    ...
    function(U) {
        ...
        // 모듈에 정의
        var _module = angular.module('sessionModule', []);
       
        _module.directive( 'session', session );

        ////////////////////////////////////////
        // Session
        ////////////////////////////////////////

        function session($window, $document) {
            ...
            function Controller( $scope, $element, $attrs, NoticeService, $q) {
                ...
                // alert('로그인이 안된 상태면 로그인 창을 띄운다(로그인 페이지로 이동한다.)');
