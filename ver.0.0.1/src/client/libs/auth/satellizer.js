 ...
 * License: MIT
 *
 * DEMO : https://satellizer.herokuapp.com/
...
(function(window, angular, undefined) {
    ...
    var module = angular.module('satellizer', []);

    ////////////////////////////////////////
    // satellizer.config
    ////////////////////////////////////////
    
    module.constant('satellizer.config', {
    ...
    module.provider('$auth', ['satellizer.config', function(config) {
            Object.defineProperties(this, {
                ...
                signoutUrl: {
                    get: function() { return config.signoutUrl; },
                    set: function(value) { config.signoutUrl = value; }
                },
    ...
    module.factory('satellizer.shared', ['$q', '$window', '$location', 'satellizer.config', 
    ...
    module.factory('satellizer.oauth', ['$q', '$http', 'satellizer.config', 'satellizer.shared', 'satellizer.Oauth1', 'satellizer.Oauth2', 
    ...
    module.factory('satellizer.local', ['$q', '$http', '$location', 'satellizer.utils', 'satellizer.shared', 'satellizer.config',
        function($q, $http, $location, utils, shared, config) {
            ...
            local.signout = function() {
                ...
                return $http.post(config.signoutUrl).then(function(response) {
                    shared.logout()
                    return response;
                });
            };
    ...
    module.factory('satellizer.Oauth2', ['$q', '$http', '$window', 'satellizer.popup', 'satellizer.utils', 'satellizer.config',
    ...
    module.factory('satellizer.Oauth1', ['$q', '$http', 'satellizer.popup',
        function($q, $http, popup) {
            return function() {
                ...
                oauth1.open = function(options, userData) {
                    angular.extend(defaults, options);
                    return popup.open(defaults.url, defaults.popupOptions).then(function(response) {
    ...
    module.factory('satellizer.popup', ['$q', '$interval', '$window', '$location', 'satellizer.utils',
...
console.log('popupWindow error : ', error);
                    }
    ...
    module.service('satellizer.utils', function() {
    ...
    module.config(['$httpProvider', 'satellizer.config',
