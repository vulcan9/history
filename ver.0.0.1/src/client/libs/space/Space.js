( function( document, window ) {
    ...
    var Version = {
        ...
        getInfo: function() {
            return "* Space Version." + " " + Version.version + " " + Version.copyright + " " + "(" + Version.modify + ")";
        }
    };
    ...
    function Space( screenID ) {
        ...
        this.config({
            // 해쉬 사용으로 브라우져 리다이이렉팅 시킴 (브라우져 history 사용)
            useHashHistory: true
        });
    }
    ...
    Space.prototype = {
        ...
        config: function (initConfigProperties){
            $.extend(this, initConfigProperties);
        },
        ...
        init: function( data ) {
            ...
            this.triggerEvent( this.viewport, "space:init", {
                api: API( this.screenID )
            } );
            if ( isReset ) return;
        ...
        _resetContent: function( documentData ) {
            ...
            var self = this;
            this.steps.forEach.apply( this.steps, [
                function() {
        ...
        */
        ...
        _onStepEnter: function( step ) {
            if ( this._lastEntered !== step ) {
                var hash = "#/tool/" + step.id;
                out( "* Event #space:stepenter : ", hash );
    ...
    */
    ...
    window.Space = function( screenID ) {
        ...
        api = {
            ...
            config: factory( instance.config )
        };
