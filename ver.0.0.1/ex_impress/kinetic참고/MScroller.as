...
package com.fdesk.whisper.components.scroller
{
	...
	*/
	...
	[Event(name="checkScrollPosition", type="flash.events.Event")]
	...
	public class MScroller extends SkinnableComponent 
		implements IFocusManagerComponent, IVisualElementContainer
	{
		 ...
		 */
		public var touchScrollHelper:TouchScrollHelper;
		 ...
		 */
		protected var captureNextClick:Boolean = false;
		...
		private function checkScrollPosition():void
		{
			...
			this.dispatchEvent( new Event("checkScrollPosition"));
		}
...
//			if (getStyle("interactionMode") == InteractionMode.TOUCH)
		...
		{
			if (skin){
				var g:Group = skin as Group;
				return g.layout as ScrollerLayout;
			}
			return null;
		}
		...
		/*
		protected function installScrollHelper(styleProp:String):void
		{
			var allStyles:Boolean = (styleProp == null || styleProp == "styleName");
		...
		*/
		 ...
		 */
		protected function touchInteractionStartingHandler(event:TouchInteractionEvent):void
		{
		 ...
		 */
		protected function touchInteractionStartHandler(event:TouchInteractionEvent):void
		{
		 ...
		 */
		protected function stopThrowEffectOnMouseDown():void
		{
			if (throwEffect && throwEffect.isPlaying)
			{
