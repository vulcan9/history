...
package com.fdesk.whisper.components.scroller
{
	...
	public class ScrollerLayout extends LayoutBase
	{
		 ...
		 *  @private
		 */
		private function getScroller():MScroller
		{
			var g:Skin = target as Skin;
			return (g && ("hostComponent" in g)) ? Object(g).hostComponent as MScroller : null;
		}
		...
		{
			var scroller:MScroller = getScroller();
		...
		{
			const scroller:MScroller = getScroller();
			if (!scroller) 
				return;
