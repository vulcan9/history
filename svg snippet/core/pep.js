...
(function ($, window, undefined) {
    ...
    function cssAnimationsSupported() {
        var animation = false,
    ...
    function Pep(el, options) {
        ...
        this._cssAnimationsSupport = cssAnimationsSupported();
    ...
    Pep.prototype = {
        ...
        */
        ...
        subscribe: function () {
            ...
            // start, move, stop event
            this.$el.on(startTrigger, $.proxy(this.onStart, this));
            this.$document.on(stopTrigger, $.proxy(this.onStop, this));
            this.$document.on(moveTrigger, $.proxy(this.onMove, this));

            // interaction이 필요한 element에서는 start 이벤트 발생시키지 않음
            var selector = this.options.elementsWithInteraction;
            this.$el.on(startTrigger, selector, this.stopPropagation);
        },
        ...
        unsubscribe: function () {
            ...
            // start, move, stop event
            this.$el.off(startTrigger, $.proxy(this.onStart, this));
            this.$document.off(stopTrigger, $.proxy(this.onStop, this));
            this.$document.off(moveTrigger, $.proxy(this.onMove, this));

            var selector = this.options.elementsWithInteraction;
            this.$el.off(startTrigger, selector, this.stopPropagation);
        },
        ...
        handleStart: function (ev) {
            ...
            // 오른쪽 마우스 눌림
            if (this.options.ignoreRightClick && ev.which === 3) return;
